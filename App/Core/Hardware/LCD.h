...
#define LCD_CS_SET LCD_CS_GPIO_Port->BSRR = LCD_CS_Pin	  // 片选端口  PA1
#define LCD_RS_SET LCD_RS_GPIO_Port->BSRR = LCD_RS_Pin	  // 数据/命令 PA3
#define LCD_RST_SET LCD_RST_GPIO_Port->BSRR = LCD_RST_Pin // 复位 PA2

#define LCD_CS_CLR LCD_CS_GPIO_Port->BSRR = (uint32_t)LCD_CS_Pin << 16U	   // 片选端口  PA1
#define LCD_RS_CLR LCD_RS_GPIO_Port->BSRR = (uint32_t)LCD_RS_Pin << 16U	   // 数据/命令 PA3
#define LCD_RST_CLR LCD_RST_GPIO_Port->BSRR = (uint32_t)LCD_RST_Pin << 16U // 复位 PA2
